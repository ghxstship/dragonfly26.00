...
export function CompaniesInvoicesTab({ data, loading }: CompaniesInvoicesTabProps) {
  ...
  const { data: hookData, loading: hookLoading } = useModuleData(workspaceId, 'companies', 'companies-invoices')
...
export default CompaniesInvoicesTab
