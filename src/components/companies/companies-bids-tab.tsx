...
export function BidsTab({ data, loading }: BidsTabProps) {
  ...
  const { data: hookData, loading: hookLoading } = useModuleData(workspaceId, 'companies', 'bids')
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button 
            size="sm" 
            className="gap-2"
            aria-label={tCommon('aria.createButton', { type: t('tabs.bids') })}
          >
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">{t('tabs.bids')}</CardTitle>
          <CardDescription>{t('descriptions.bids')}</CardDescription>
        </CardHeader>
        <CardContent>
          {items.length === 0 ? (
            <div className="text-center py-12">
              <div className="text-muted-foreground">
                <p className="text-lg font-semibold mb-2">
                  {tCommon('emptyState.title', { resource: t('tabs.bids') })}
                </p>
