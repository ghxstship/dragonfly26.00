...
export function BidsTab({ data, loading }: BidsTabProps) {
  ...
  const { data: hookData, loading: hookLoading, error } = useModuleData(workspaceId, 'companies', 'bids')
  ...
  return (
    <div className="space-y-3 md:space-y-4 lg:space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle aria-hidden="true" className="text-base">{t('tabs.bids')}</CardTitle>
