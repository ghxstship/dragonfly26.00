...
export function OffersTab({ data, loading }: OffersTabProps) {
  ...
  const { data: hookData, loading: hookLoading, error } = useModuleData(workspaceId, 'jobs', 'offers')
  ...
  return (
    <div className="space-y-3 md:space-y-4 lg:space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle aria-hidden="true" className="text-base">{t('tabs.offers')}</CardTitle>
