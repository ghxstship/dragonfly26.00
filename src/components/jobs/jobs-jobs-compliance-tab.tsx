...
interface JobsComplianceTabProps {
  data?: any[]
  loading?: boolean
}

export function JobsComplianceTab({ data, loading }: JobsComplianceTabProps) {
  ...
  const { data: hookData, loading: hookLoading } = useModuleData(workspaceId, 'jobs', 'jobs-compliance')
...
export default JobsComplianceTab
