...
export function ArchivedTab({ data, loading }: ArchivedTabProps) {
  ...
  const { data: hookData, loading: hookLoading, error } = useModuleData(workspaceId, 'jobs', 'archived')
  ...
  return (
    <div className="space-y-3 md:space-y-4 lg:space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base" aria-hidden="true">{t('tabs.archived')}</CardTitle>
