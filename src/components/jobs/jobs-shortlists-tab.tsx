...
export function ShortlistsTab({ data, loading }: ShortlistsTabProps) {
  ...
  const { data: hookData, loading: hookLoading, error } = useModuleData(workspaceId, 'jobs', 'shortlists')
  ...
  return (
    <div className="space-y-3 md:space-y-4 lg:space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base" aria-hidden="true">{t('tabs.shortlists')}</CardTitle>
