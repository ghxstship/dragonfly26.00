...
export function CompletedTab({ data, loading }: CompletedTabProps) {
  ...
  const { data: hookData, loading: hookLoading, error } = useModuleData(workspaceId, 'jobs', 'completed')
  ...
  return (
    <div className="space-y-3 md:space-y-4 lg:space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle aria-hidden="true" className="text-base">{t('tabs.completed')}</CardTitle>
