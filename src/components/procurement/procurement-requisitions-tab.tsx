...
export function RequisitionsTab({ data, loading }: RequisitionsTabProps) {
  ...
  const { data: hookData, loading: hookLoading, error } = useModuleData(workspaceId, 'procurement', 'requisitions')
  ...
  return (
    <div className="space-y-3 md:space-y-4 lg:space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base" aria-hidden="true">{t('tabs.requisitions')}</CardTitle>
