...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-all duration-200 ease-spring focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 hover:scale-105 transform",
  {
    variants: {
      variant: {
        default:
