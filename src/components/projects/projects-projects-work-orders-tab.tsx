...
interface ProjectsWorkOrdersTabProps {
  data?: Record<string, unknown>[]
  loading?: boolean
}

export function ProjectsWorkOrdersTab({ data, loading }: ProjectsWorkOrdersTabProps) {
  const t = useTranslations('production.projects.work_orders')
  ...
  if (error) {
    return (
      <div className="flex items-center justify-center h-full" role="alert" aria-live="assertive">
        <div className="text-center">
          <Wrench aria-hidden="true" className="h-8 w-8 text-destructive mx-auto mb-4" />
...
export default ProjectsWorkOrdersTab
