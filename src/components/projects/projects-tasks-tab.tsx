...
export function TasksTab({ data, loading }: TasksTabProps) {
  const t = useTranslations('production.projects.tasks')
  const tCommon = useTranslations('common')
  const params = useParams()
  const workspaceId = params?.workspaceId as string
  
  // Fetch data if not provided
  const { data: hookData, loading: hookLoading, error } = useModuleData(workspaceId, 'projects', 'tasks')
