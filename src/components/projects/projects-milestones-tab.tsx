...
export function MilestonesTab({ data, loading }: MilestonesTabProps) {
  const t = useTranslations('production.projects.milestones')
  const tCommon = useTranslations('common')
  const params = useParams()
  const workspaceId = params?.workspaceId as string
  
  // Fetch data if not provided
  const { data: hookData, loading: hookLoading, error } = useModuleData(workspaceId, 'projects', 'milestones')
