  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold tracking-tight">Run of Show</h2>
      ...
      {runOfShow.length === 0 && (
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <h3 className="text-lg font-semibold mb-2">No Run of Show Yet</h3>
            <p className="text-muted-foreground text-center mb-4">
              Create your first cue to start building your show timeline
            </p>
            <Button>
              <Plus className="h-4 w-4 mr-2" />
              Create First Cue
