...
export function PersonnelTab({ data, loading }: PersonnelTabProps) {
  const t = useTranslations('production.people.personnel')
  const tCommon = useTranslations('common')
  const params = useParams()
  const workspaceId = params?.workspaceId as string
  
  // Fetch data if not provided
  const { data: hookData, loading: hookLoading, error } = useModuleData(workspaceId, 'people', 'personnel')
