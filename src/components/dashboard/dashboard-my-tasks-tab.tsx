      ...
      <section role="region" aria-labelledby="tasks-stats">
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-center">
              <p className="text-3xl font-bold text-red-600" aria-label={t('tasksDueToday', { count: 4 })}>4</p>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-center">
              <p className="text-3xl font-bold text-blue-600" aria-label={t('tasksInProgress', { count: 3 })}>3</p>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-center">
              <p className="text-3xl font-bold text-purple-600" aria-label={t('tasksCreatedByYou', { count: 3 })}>3</p>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-center">
              <p className="text-3xl font-bold text-green-600" aria-label={t('tasksCompletedThisWeek', { count: 42 })}>42</p>
        ...
        <CardContent>
          <div className="grid grid-cols-3 gap-4 text-center">
            <div className="p-4 border rounded-lg">
              <p className="text-2xl font-bold" aria-label="42 completed">42</p>
              <p className="text-xs text-muted-foreground mt-1">{t('completed')}</p>
            </div>
            <div className="p-4 border rounded-lg">
              <p className="text-2xl font-bold" aria-label="7 active">7</p>
              <p className="text-xs text-muted-foreground mt-1">{t('active')}</p>
            </div>
            <div className="p-4 border rounded-lg">
              <p className="text-2xl font-bold" aria-label="94% on-time rate">94%</p>
