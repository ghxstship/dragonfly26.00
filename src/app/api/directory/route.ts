...
/**
 * POST - Create new directory record
 */
...
/**
 * PUT - Update existing directory record
 */
export async function PUT(request: Request) {
  try {
    ...
    console.error('PUT directory error:', error)
    return NextResponse.json(
      { error: error.message || 'Internal server error' },
      { status: 500 }
    )
...
/**
 * DELETE - Remove directory record
 */
