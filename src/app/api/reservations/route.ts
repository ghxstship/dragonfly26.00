...
/**
 * GET - Fetch reservations records
 */
...
/**
 * POST - Create new reservations record
 */
export async function POST(request: Request) {
  try {
    ...
    return NextResponse.json(
      { data, message: 'reservations created successfully' },
      { status: 201 }
    )
  } catch (error: any) {
...
/**
 * PUT - Update existing reservations record
 */
...
/**
 * DELETE - Remove reservations record
 */
