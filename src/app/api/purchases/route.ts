...
/**
 * POST - Create new purchases record
 */
export async function POST(request: Request) {
  try {
    ...
    return NextResponse.json(
      { data, message: 'purchases created successfully' },
      { status: 201 }
    )
  } catch (error: any) {
...
/**
 * PUT - Update existing purchases record
 */
...
/**
 * DELETE - Remove purchases record
 */
