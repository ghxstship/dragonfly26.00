...
/**
 * POST - Create new milestones record
 */
export async function POST(request: Request) {
  try {
    ...
    return NextResponse.json(
      { data, message: 'milestones created successfully' },
      { status: 201 }
    )
  } catch (error: any) {
...
/**
 * PUT - Update existing milestones record
 */
...
/**
 * DELETE - Remove milestones record
 */
