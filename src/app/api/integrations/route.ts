...
/**
 * GET - Fetch integrations records
 */
...
/**
 * POST - Create new integrations record
 */
export async function POST(request: Request) {
  try {
    ...
    return NextResponse.json(
      { data, message: 'integrations created successfully' },
      { status: 201 }
    )
  } catch (error: any) {
...
/**
 * PUT - Update existing integrations record
 */
...
/**
 * DELETE - Remove integrations record
 */
