...
export async function POST(request: Request) {
  try {
    ...
    return NextResponse.json(
      { data, message: 'offers created successfully' },
      { status: 201 }
    )
  } catch (error: any) {
...
/**
 * PUT - Update existing offers record
 */
