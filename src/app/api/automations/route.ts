...
/**
 * POST - Create new automations record
 */
export async function POST(request: Request) {
  try {
    ...
    return NextResponse.json(
      { data, message: 'automations created successfully' },
      { status: 201 }
    )
  } catch (error: any) {
...
/**
 * PUT - Update existing automations record
 */
...
/**
 * DELETE - Remove automations record
 */
