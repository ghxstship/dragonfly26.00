...
/**
 * POST - Create new discussions record
 */
export async function POST(request: Request) {
  try {
    ...
    return NextResponse.json(
      { data, message: 'discussions created successfully' },
      { status: 201 }
    )
  } catch (error: any) {
...
/**
 * PUT - Update existing discussions record
 */
...
/**
 * DELETE - Remove discussions record
 */
