...
/**
 * GET - Fetch recommendations records
 */
...
/**
 * POST - Create new recommendations record
 */
export async function POST(request: Request) {
  try {
    ...
    return NextResponse.json(
      { data, message: 'recommendations created successfully' },
      { status: 201 }
    )
  } catch (error: any) {
...
/**
 * PUT - Update existing recommendations record
 */
...
/**
 * DELETE - Remove recommendations record
 */
