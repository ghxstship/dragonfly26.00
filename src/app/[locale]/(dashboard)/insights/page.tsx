...
import { Plus, Lightbulb, TrendingUp, AlertCircle, CheckCircle2, Target, Sparkles } from "lucide-react"
...
// Mock data - Strategic objectives for any industry
const mockObjectives: Goal[] = [
  {
    id: "1",
    organization_id: "org-1",
    name: "Increase Customer Satisfaction Score",
    description: "Achieve 90% customer satisfaction rating through improved service delivery",
    type: "percentage",
    target_value: 90,
    current_value: 78,
    unit: "%",
  ...
  },
  {
    ...
    description: "Cut operational expenses by 15% through process optimization",
    type: "percentage",
    target_value: 15,
    current_value: 8,
    unit: "% reduction",
  ...
  },
  {
    ...
    description: "Enter 3 new geographic markets this year",
    type: "number",
    target_value: 3,
    current_value: 1,
    unit: "markets",
