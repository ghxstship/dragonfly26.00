        ...
        <div className="max-w-7xl px-4 sm:px-6 lg:px-8 mx-auto px-4 md:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 md:gap-3 lg:gap-4 md:gap-3 md:gap-4 lg:gap-6 lg:gap-8 max-w-5xl px-4 sm:px-6 lg:px-8 mx-auto px-4 md:px-6">
            <div className="bg-white dark:bg-gray-800 p-4 md:p-8 rounded-xl border-2 border-gray-200 dark:border-gray-700 text-center">
              ...
              <h3 className="text-lg font-heading uppercase text-gray-900 dark:text-white mb-2">Email Us</h3>
              <p className="text-gray-600 dark:text-gray-400 mb-4">General inquiries and support</p>
            ...
            <div className="bg-white dark:bg-gray-800 p-4 md:p-8 rounded-xl border-2 border-gray-200 dark:border-gray-700 text-center">
              ...
              <h3 className="text-lg font-heading uppercase text-gray-900 dark:text-white mb-2">Live Chat</h3>
            ...
            <div className="bg-white dark:bg-gray-800 p-4 md:p-8 rounded-xl border-2 border-gray-200 dark:border-gray-700 text-center">
              ...
              <h3 className="text-lg font-heading uppercase text-gray-900 dark:text-white mb-2">Schedule Demo</h3>
              <p className="text-gray-600 dark:text-gray-400 mb-4">See ATLVS in action</p>
              <a href="/demo">
