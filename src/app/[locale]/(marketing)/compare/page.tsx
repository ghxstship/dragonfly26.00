          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-12">
            {comparisons.map((comp) => (
              <Link
                ...
                className="mx-auto p-4 md:p-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg hover:border-blue-300 hover:shadow-lg transition-all max-w-sm md:max-w-none"
              >
