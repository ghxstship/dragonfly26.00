    ...
    <div className="pt-20">
      <section className="py-10 md:py-16 lg:py-20 px-4 sm:px-4 md:px-6 lg:px-4 md:px-6 lg:px-8">
        <div className="max-w-7xl px-4 sm:px-6 lg:px-8 mx-auto px-4 md:px-6 lg:px-8">
          ...
          <div className="bg-gray-50 rounded-xl p-4 md:p-8 lg:p-12 text-center">
            <p className="text-lg md:text-base md:text-lg lg:text-xl lg:text-2xl font-semibold text-gray-900 mb-2">Coming Soon</p>
