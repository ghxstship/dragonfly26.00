    ...
    <div className="pt-20">
      ...
      <section className="py-10 md:py-16 lg:py-20 px-4 sm:px-4 md:px-6 lg:px-4 md:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto text-center">
          <h1 className="text-5xl md:text-3xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
      ...
      <section className="py-10 md:py-16 lg:py-20 px-4 sm:px-4 md:px-6 lg:px-4 md:px-6 lg:px-8">
        <div className="max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto">
          <div className="prose prose-lg max-w-none">
            <h2 className="text-base md:text-lg lg:text-xl md:text-lg md:text-xl lg:text-2xl lg:text-3xl font-bold text-gray-900 mb-6">Our Story</h2>
            ...
            <h2 className="text-base md:text-lg lg:text-xl md:text-lg md:text-xl lg:text-2xl lg:text-3xl font-bold text-gray-900 mb-6 mt-12">Our Mission</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-base md:text-lg lg:text-xl md:text-lg md:text-xl lg:text-2xl lg:text-3xl font-bold text-gray-900 mb-6 mt-12">Our Vision</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-base md:text-lg lg:text-xl md:text-lg md:text-xl lg:text-2xl lg:text-3xl font-bold text-gray-900 mb-6 mt-12">Our Values</h2>
