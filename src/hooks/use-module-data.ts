...
const TAB_TO_TABLE_MAP: Record<string, { table: string; select?: string; orderBy?: string }> = {
  ...
  'my-files': { table: 'files', select: '*, uploaded_by_user:profiles!uploaded_by(first_name, last_name)', orderBy: 'created_at' },
  
  // Projects
  'productions': { table: 'productions', select: '*, workspace:workspaces!workspace_id(name), project_manager:profiles!project_manager_id(first_name, last_name)', orderBy: 'created_at' },
  'activations': { table: 'productions', select: '*, workspace:workspaces!workspace_id(name), project_manager:profiles!project_manager_id(first_name, last_name)', orderBy: 'created_at' },
  ...
  // Files
  'all-documents': { table: 'files', select: '*, uploaded_by_user:profiles!uploaded_by(first_name, last_name)', orderBy: 'created_at' },
  'contracts': { table: 'files', select: '*, uploaded_by_user:profiles!uploaded_by(first_name, last_name)', orderBy: 'created_at' },
  'riders': { table: 'files', select: '*, uploaded_by_user:profiles!uploaded_by(first_name, last_name)', orderBy: 'created_at' },
  'tech-specs': { table: 'files', select: '*, uploaded_by_user:profiles!uploaded_by(first_name, last_name)', orderBy: 'created_at' },
  'call-sheets': { table: 'files', select: '*, uploaded_by_user:profiles!uploaded_by(first_name, last_name)', orderBy: 'created_at' },
  'insurance-permits': { table: 'files', select: '*, uploaded_by_user:profiles!uploaded_by(first_name, last_name)', orderBy: 'created_at' },
  'media-assets': { table: 'files', select: '*, uploaded_by_user:profiles!uploaded_by(first_name, last_name)', orderBy: 'created_at' },
  'production-reports': { table: 'files', select: '*, uploaded_by_user:profiles!uploaded_by(first_name, last_name)', orderBy: 'created_at' },
  'shared': { table: 'files', select: '*, uploaded_by_user:profiles!uploaded_by(first_name, last_name)', orderBy: 'created_at' },
  'archive': { table: 'files', select: '*, uploaded_by_user:profiles!uploaded_by(first_name, last_name)', orderBy: 'created_at' },
  ...
  'documents': { table: 'files', select: '*, category:file_categories!category_id(name), uploaded_by_user:profiles!uploaded_by(first_name, last_name)', orderBy: 'created_at' },
  ...
  'forecasting': { table: 'budgets', select: '*, production:productions!production_id(name), created_by_user:profiles!created_by(first_name, last_name)', orderBy: 'created_at' },
  ...
  'revenue': { table: 'financial_transactions', select: '*, budget:budgets!budget_id(name), production:productions!production_id(name), company:companies!company_id(name), created_by_user:profiles!created_by(first_name, last_name)', orderBy: 'transaction_date' },
  'expenses': { table: 'financial_transactions', select: '*, budget:budgets!budget_id(name), production:productions!production_id(name), company:companies!company_id(name), created_by_user:profiles!created_by(first_name, last_name)', orderBy: 'transaction_date' },
  ...
  'payments': { table: 'financial_transactions', select: '*, budget:budgets!budget_id(name), production:productions!production_id(name), company:companies!company_id(name), created_by_user:profiles!created_by(first_name, last_name)', orderBy: 'transaction_date' },
  ...
  'taxes': { table: 'financial_transactions', select: '*, budget:budgets!budget_id(name), production:productions!production_id(name), company:companies!company_id(name), created_by_user:profiles!created_by(first_name, last_name)', orderBy: 'transaction_date' },
  'accounts': { table: 'gl_codes', select: '*', orderBy: 'code' },
  'gl-codes': { table: 'gl_codes', select: '*', orderBy: 'code' },
  
  // Procurement
  'fulfillment': { table: 'purchase_orders', select: '*, company:companies!company_id(name)', orderBy: 'order_date' },
  'orders': { table: 'purchase_orders', select: '*, company:companies!company_id(name)', orderBy: 'order_date' },
