      ...
      <div className={cn("mx-auto", container['6xl'])}>
        ...
        <div className={cn("grid md:grid-cols-3", spacing.gapLoose)}>
          <div className={cn("bg-white dark:bg-gray-800 rounded-xl", padding.section)}>
            ...
            <div>
              <p className="text-gray-900 dark:text-white">{t('testimonial1Author')}</p>
          ...
          <div className={cn("bg-white dark:bg-gray-800 rounded-xl", padding.section)}>
            ...
            <div>
              <p className="text-gray-900 dark:text-white">{t('testimonial2Author')}</p>
          ...
          <div className={cn("bg-white dark:bg-gray-800 rounded-xl", padding.section)}>
            ...
            <div>
              <p className="text-gray-900 dark:text-white">{t('testimonial3Author')}</p>
