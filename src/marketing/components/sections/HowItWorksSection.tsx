      ...
      <div className={cn("mx-auto", container['6xl'])}>
        ...
        <div className="grid md:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
          <div className="text-center">
            ...
            <h3 className="text-lg  text-gray-900 dark:text-white mb-2 font-heading uppercase">{t('step1Title')}</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg  text-gray-900 dark:text-white mb-2 font-heading uppercase">{t('step2Title')}</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg  text-gray-900 dark:text-white mb-2 font-heading uppercase">{t('step3Title')}</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg  text-gray-900 dark:text-white mb-2 font-heading uppercase">{t('step4Title')}</h3>
