      ...
      <div className={cn("mx-auto", container['6xl'])}>
        ...
        <div className="grid md:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
          <div className="text-center">
            ...
            <h3 className="text-lg  text-gray-900 dark:text-white mb-2 font-heading uppercase">{tGen('step1Title')}</h3>
            <p className="text-gray-600 dark:text-gray-400">{tGen('step1Description')}</p>
          </div>
          <div className="text-center">
            ...
            <h3 className="text-lg  text-gray-900 dark:text-white mb-2 font-heading uppercase">{tGen('step2Title')}</h3>
            <p className="text-gray-600 dark:text-gray-400">{tGen('step2Description')}</p>
          </div>
          <div className="text-center">
            ...
            <h3 className="text-lg  text-gray-900 dark:text-white mb-2 font-heading uppercase">{tGen('step3Title')}</h3>
            <p className="text-gray-600 dark:text-gray-400">{tGen('step3Description')}</p>
          </div>
          <div className="text-center">
            ...
            <h3 className="text-lg  text-gray-900 dark:text-white mb-2 font-heading uppercase">{tGen('step4Title')}</h3>
            <p className="text-gray-600 dark:text-gray-400">{tGen('step4Description')}</p>
          </div>
        </div>
      </div>
    </section>
