      ...
      <div className={cn("mx-auto", container['6xl'])}>
        ...
        <div className={grid.cards4}>
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">{t('pain1Title')}</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">{t('pain2Title')}</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">{t('pain3Title')}</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">{t('pain4Title')}</h3>
