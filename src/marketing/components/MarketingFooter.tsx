...
export function MarketingFooter(): JSX.Element {
  ...
  return (
    <footer className="bg-gray-900 dark:bg-gray-950 text-gray-300 dark:text-gray-400 py-6 md:py-4 md:py-6 lg:py-8 lg:py-12 px-4 sm:px-4 md:px-6 lg:px-8">
      <div className={cn("mx-auto", container['6xl'])}>
        <div className="grid grid-cols-2 md:grid-cols-5 gap-6 md:gap-8 mb-4 md:mb-6 lg:mb-8">
          {/* Product Column */}
          <div>
            <h3 className="text-white font-heading uppercase text-lg mb-4">{t('productTitle')}</h3>
          ...
          {/* Company Column */}
          <div>
            <h3 className="text-white font-heading uppercase text-lg mb-4">{t('companyTitle')}</h3>
            <ul className={spacing.listTight}>
          ...
          {/* Resources Column */}
          <div>
            <h3 className="text-white font-heading uppercase text-lg mb-4">{t('resourcesTitle')}</h3>
            <ul className={spacing.listTight}>
          ...
          {/* Support Column */}
          <div>
            <h3 className="text-white font-heading uppercase text-lg mb-4">{t('support')}</h3>
            <ul className={spacing.listTight}>
          ...
          {/* Legal Column */}
          <div>
            <h3 className="text-white font-heading uppercase text-lg mb-4">{t('legalTitle')}</h3>
            <ul className={spacing.listTight}>
