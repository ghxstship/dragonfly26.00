...
// Only tables that actually exist in the database
const tables = [
  // Insight tables (10 tables)
  "insight_recommendations", "insight_scenarios", "insight_segments", 
  "insight_summaries", "insight_what_if",
  // Job tables (7 tables - no job_screenings)
  "job_applications", "job_candidates", "job_interviews", 
  "job_offers", "job_onboarding", "job_postings", "job_requisitions",
  // Location tables (7 tables - different names than expected)
  "location_access", "location_amenities", "location_bookings",
  "location_capacity", "location_equipment", "location_floor_plans", "location_zones"
];

let sql = `-- Migration: Fix Final Auth RLS Warnings (Corrected)
...
-- Total auth warnings resolved across all migrations: ~${52 + (tables.length * 4)} warnings
-- 
